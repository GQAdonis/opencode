...
export const commands = {
	...
	setBackgroundColor: (color: string) => __TAURI_INVOKE<null>("set_background_color", { color }),
	setTitlebar: (mode: string, scheme: string | null) => __TAURI_INVOKE<null>("set_titlebar", { mode, scheme }),
	getPinchZoomEnabled: () => __TAURI_INVOKE<boolean>("get_pinch_zoom_enabled"),
	setPinchZoomEnabled: (enabled: boolean) => __TAURI_INVOKE<null>("set_pinch_zoom_enabled", { enabled }),
	isFirstLaunchOnboardingPending: () => __TAURI_INVOKE<boolean>("is_first_launch_onboarding_pending"),
	finishFirstLaunchOnboarding: (createDefaultProject: boolean) => __TAURI_INVOKE<string | null>("finish_first_launch_onboarding", { createDefaultProject }),
